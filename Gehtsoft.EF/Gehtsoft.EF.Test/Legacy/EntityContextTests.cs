...
{
    public class EntityContextTests : IClassFixture<EntityContextTests.Fixture>
    {
        ...
        public EntityContextTests(Fixture fixture)
        {
            mFixture = fixture;
        }
        ...
        private void DoTest(IEntityContext context)
        {
            try
            {
        ...
        public void SqlEntityContext(string connectionName)
        {
