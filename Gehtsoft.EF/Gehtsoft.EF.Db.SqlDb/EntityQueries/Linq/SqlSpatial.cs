...
{
    /// <summary>
    /// Marker methods for geometry (spatial) operations inside a LINQ query - the geo twin of
    /// <see cref="SqlFunction"/>. They exist only to be recognised by the LINQ expression compiler and
    /// translated to the dialect's spatial SQL (<c>ST_Intersects</c>, <c>ST_Area</c>, and so on); calling one
    /// directly throws.
    ///
    ...
    public static class SqlSpatial
    {
        ...
        /// <summary>The geometry and the operand cross (throws <c>FeatureNotSupported</c> on Oracle).</summary>
        ...
        /// <summary>The geometry is within <paramref name="distance"/> of the operand (planar units).</summary>
