...
namespace Gehtsoft.EF.Db.SqlDb.EntityQueries
{
        ...
        where T : class
    {
        ...
        private List<PropertyTarget> mPropertyTargets = new List<PropertyTarget>();
        private List<Action<T, SelectEntitiesQueryBase>> mActions = new List<Action<T, SelectEntitiesQueryBase>>();
