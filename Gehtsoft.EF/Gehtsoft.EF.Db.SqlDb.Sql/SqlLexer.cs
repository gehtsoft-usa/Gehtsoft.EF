...
namespace Gehtsoft.EF.Db.SqlDb.Sql
{
	...
	public class SqlLexer : ContextFreeLexer
	{
		...
		private static readonly Symbol[] terminals = {
			...
			new Symbol(0x005F, "null"),
			new Symbol(0x0060, "TRUE"),
			new Symbol(0x0061, "FALSE"),
			new Symbol(0x0062, "DATE"),
			new Symbol(0x0063, ";"),
			new Symbol(0x0065, "-"),
			new Symbol(0x0066, "+"),
			new Symbol(0x0067, "*"),
			...
			new Symbol(0x0072, "("),
			new Symbol(0x0073, ")"),
			new Symbol(0x0074, "TRIM"),
			new Symbol(0x0075, "LTRIM"),
			new Symbol(0x0076, "RTRIM"),
			new Symbol(0x0077, "LEADING"),
			new Symbol(0x0078, "TRAILING"),
			new Symbol(0x0079, "BOTH"),
			new Symbol(0x007A, "NOT"),
			new Symbol(0x007B, "AND"),
			new Symbol(0x007C, "OR"),
			new Symbol(0x007D, "DISTINCT"),
			new Symbol(0x007E, "ALL"),
			new Symbol(0x007F, "COUNT"),
			new Symbol(0x0080, "MAX"),
			new Symbol(0x0081, "MIN"),
			new Symbol(0x0082, "AVG"),
			new Symbol(0x0083, "SUM"),
			new Symbol(0x0084, "COUNT(*)"),
			new Symbol(0x0086, "AS"),
			new Symbol(0x0087, "."),
			new Symbol(0x0088, "WHERE"),
			new Symbol(0x0089, "FROM"),
			new Symbol(0x008B, "AUTO"),
			new Symbol(0x008C, "JOIN"),
			new Symbol(0x008D, "INNER"),
			new Symbol(0x008E, "OUTER"),
			new Symbol(0x008F, "LEFT"),
			new Symbol(0x0090, "RIGHT"),
			new Symbol(0x0091, "FULL"),
			new Symbol(0x0092, "ON"),
			new Symbol(0x0093, "SELECT"),
			new Symbol(0x0094, "ORDER BY"),
			new Symbol(0x0096, "ASC"),
			new Symbol(0x0097, "DESC"),
			new Symbol(0x0098, "GROUP BY"),
			new Symbol(0x009A, "LIMIT"),
			new Symbol(0x009B, "OFFSET") };
		/// <summary>
