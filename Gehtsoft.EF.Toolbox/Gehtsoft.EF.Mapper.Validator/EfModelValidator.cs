...
namespace Gehtsoft.EF.Mapper.Validator
{
    ...
    {
        internal SqlDbLanguageSpecifics LanguageSpecifics { get; private set; }
        internal IValidatorConnectionFactory ConnectionFactory { get; private set; }
            ...
            {
                {
                    ...
                    if (attribute != null)
                    {
                        ...
                        if (attribute.WithMessage != null)
                            builder.WithMessage((string) attribute.WithMessage);
                    }
                }
        ...
        public void ValidateModel(IEfValidatorMessageProvider messageProvider = null, bool aspNetValidation = false)
        {
            ...
            if (mapEntitAttribute == null)
                throw new ArgumentException("The model isn't associate with the entity", nameof(T));
            ...
            foreach (var property in map.Mappings)
            {
                ...
                {
                    EntityPropertyAccessor entityProperty = (EntityPropertyAccessor) property.Target;
                    ...
                    if ((entityProperty.ColumnInfo.Unique) && ConnectionFactory != null)
                        RuleFor(property.Source.Name).MustBeUnqiue().WhenNotNull()
